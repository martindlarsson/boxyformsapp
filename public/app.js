...
// Initialize Firebase
firebase.initializeApp(__webpack_require__(1));
...
app.ports.getForm.subscribe(function (formId) {
    ...
    eventsRef.orderByChild("formId").equalTo(formId).limitToFirst(1).once('value').then(function (snapshot) {
        // console.log("Now somethin came from Firebase!");
...
var _user$project$Form_Models$Form = F6(
	function (a, b, c, d, e, f) {
		return {eventId: a, eventName: b, orgName: c, formId: d, formName: e, formSteps: f};
	});
var _user$project$Form_Models$JsonForm = F6(
	function (a, b, c, d, e, f) {
		return {eventId: a, eventName: b, orgName: c, formId: d, formName: e, formSteps: f};
	});
...
var _user$project$Form_Models$fromJsonFormToForm = function (maybeJsonForm) {
	var maybeFormStepList = function () {
		var _p4 = maybeJsonForm;
		if (_p4.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _user$project$Form_Models$toFormStepList(_p4._0.formSteps);
		}
	}();
	var _p5 = maybeFormStepList;
	if (_p5.ctor === 'Nothing') {
		return _elm_lang$core$Result$Err('The form holds no form steps');
	} else {
		var _p6 = maybeJsonForm;
		if (_p6.ctor === 'Nothing') {
			return _elm_lang$core$Result$Err('Empty form');
		} else {
			var _p7 = _p6._0;
			return _elm_lang$core$Result$Ok(
				A6(_user$project$Form_Models$Form, _p7.eventId, _p7.eventName, _p7.orgName, _p7.formId, _p7.formName, _p5._0));
		}
	}
};
var _user$project$Form_Models$nextFormStep = function (_p8) {
	var _p9 = _p8;
	var _p11 = _p9.nextSteps;
	var newNextSteps = _user$project$Helpers_ListHelpers$listTail(_p11);
	var newCurrStep = _elm_lang$core$List$head(_p11);
	var newPrevSteps = A2(
		_elm_lang$core$Basics_ops['++'],
		_p9.previouseSteps,
		{
	...
	var _p10 = newCurrStep;
	if (_p10.ctor === 'Nothing') {
		return _elm_lang$core$Result$Err('Can not go to next beqause there are no next step.');
	} else {
		return _elm_lang$core$Result$Ok(
			A3(_user$project$Form_Models$FormStepList, newPrevSteps, _p10._0, newNextSteps));
	}
};
var _user$project$Form_Models$previouseFormStep = function (_p12) {
	var _p13 = _p12;
	var _p15 = _p13.previouseSteps;
	var newNextSteps = A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
		...
		_p13.nextSteps);
	var newCurrStep = _user$project$Helpers_ListHelpers$lastInList(_p15);
	var newPrevSteps = _user$project$Helpers_ListHelpers$dropLast(_p15);
	var _p14 = newCurrStep;
	if (_p14.ctor === 'Nothing') {
		return _elm_lang$core$Result$Err('Empty current step');
	} else {
		return _elm_lang$core$Result$Ok(
			A3(_user$project$Form_Models$FormStepList, newPrevSteps, _p14._0, newNextSteps));
	}
};
...
var _user$project$Form_Models$Loading = {ctor: 'Loading'};
var _user$project$Form_Models$getFormStepState = function (_p17) {
	var _p18 = _p17;
	var _p19 = {ctor: '_Tuple3', _0: _p18.previouseSteps, _1: _p18.currentStep, _2: _p18.nextSteps};
	_v12_4:
	do {
	...
	return _user$project$Form_Models$Loading;
};
...
var _user$project$Models$Model = F5(
	function (a, b, c, d, e) {
		return {events: a, route: b, form: c, answers: d, mdl: e};
	});
...
var _user$project$Routing$formPath = function (formId) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#form/',
		_elm_lang$core$Basics$toString(formId));
};
					...
					_1: {
						...
						_1: {
							...
							_0: _debois$elm_mdl$Material_Button$link(
								_user$project$Routing$formPath(eventForm.formId)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Form_FormDecoder$decodeForm = function (modelJson) {
	return A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Form_FormDecoder$decodeFormList, modelJson);
};
...
var _user$project$Form_FormView$formView = function (model) {
	...
	switch (_p2.ctor) {
		case 'NoForm':
			return _elm_lang$html$Html$text('Inget formulär har valts');
		case 'LoadingForm':
			return _elm_lang$html$Html$text('Laddar in formuläret, snart så...');
		case 'ErrorLoadingForm':
			return _elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], 'Fel vid laddning av formulär. ', _p2._0));
		default:
			var _p3 = _p2._0;
			var currentStep = _user$project$Form_Models$getCurrentStep(_p3.formSteps);
			var formStepState = _user$project$Form_Models$getFormStepState(_p3.formSteps);
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A3(_user$project$Form_FormView$formStepView, currentStep, model.answers, model.mdl),
					_1: {
						ctor: '::',
						_0: A2(
							_debois$elm_mdl$Material_Grid$grid,
...
var _user$project$Ports$getEvents = _elm_lang$core$Native_Platform.outgoingPort(
	'getEvents',
	function (v) {
		return null;
	});
var _user$project$Ports$gotEventList = _elm_lang$core$Native_Platform.incomingPort(
	'gotEventList',
														...
														return A2(
															...
															function (webLink) {
																return _elm_lang$core$Json_Decode$succeed(
																	{eventId: eventId, eventName: eventName, eventForms: eventForms, organizer: organizer, organizerId: organizerId, $public: $public, webLink: webLink});
															},
															A2(_elm_lang$core$Json_Decode$field, 'webLink', _elm_lang$core$Json_Decode$string));
													},
													A2(_elm_lang$core$Json_Decode$field, 'public', _elm_lang$core$Json_Decode$bool));
											},
											A2(_elm_lang$core$Json_Decode$field, 'organizerId', _elm_lang$core$Json_Decode$int));
									},
									A2(_elm_lang$core$Json_Decode$field, 'organizer', _elm_lang$core$Json_Decode$string));
							},
							A2(
								_elm_lang$core$Json_Decode$field,
								'eventForms',
									...
									A2(
										...
										function (formId) {
											return A2(
												...
												A2(_elm_lang$core$Json_Decode$field, 'formName', _elm_lang$core$Json_Decode$string));
										},
										A2(_elm_lang$core$Json_Decode$field, 'formId', _elm_lang$core$Json_Decode$int)))));
					},
					A2(_elm_lang$core$Json_Decode$field, 'eventName', _elm_lang$core$Json_Decode$string));
			},
			A2(_elm_lang$core$Json_Decode$field, 'eventId', _elm_lang$core$Json_Decode$int))));
var _user$project$Ports$getForm = _elm_lang$core$Native_Platform.outgoingPort(
	'getForm',
	function (v) {
		return v;
	});
var _user$project$Ports$gotForm = _elm_lang$core$Native_Platform.incomingPort('gotForm', _elm_lang$core$Json_Decode$value);

var _user$project$Update$updateAnswers = F3(
	function (model, questionId, answer) {
		var oldAnswers = model.answers;
		var keepAnswers = A2(
			_elm_lang$core$List$filter,
			function (answer) {
		...
		var _p0 = A2(
			...
			'updateAnsers',
			A2(_elm_lang$core$Basics_ops['++'], keepAnswers, newAnswer));
	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'EventFormClicked':
				var _p3 = _p1._0;
				var _p2 = A2(_elm_lang$core$Debug$log, 'EventFormClicked', _p3);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$getForm(_p3)
				};
			case 'GotFormMsg':
				var _p4 = _p1._0;
				if (_p4.ctor === 'Ok') {
					var maybeJsonForm = _elm_lang$core$List$head(_p4._0);
					var newForm = _user$project$Form_Models$fromJsonFormToForm(maybeJsonForm);
					var _p5 = newForm;
					if (_p5.ctor === 'Err') {
						return {
							ctor: '_Tuple2',
			...
			case 'OnLocationChange':
				...
				var command = function () {
					...
					switch (_p7.ctor) {
						case 'FormRoute':
							return _user$project$Ports$getForm(_p7._0);
						case 'EventListRoute':
							return _elm_lang$core$List$isEmpty(model.events) ? _user$project$Ports$getEvents(
			...
			case 'SetAnswer':
				var newAnsers = A3(_user$project$Update$updateAnswers, model, _p1._0, _p1._1);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'FormNextButtonClicked':
				...
				var _p8 = formState;
				if (_p8.ctor === 'FormLoaded') {
					var _p10 = _p8._0;
					var formStepList = _user$project$Form_Models$nextFormStep(_p10.formSteps);
					var _p9 = formStepList;
					if (_p9.ctor === 'Err') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									form: _user$project$Form_Models$ErrorLoadingForm(_p9._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						var newForm = _elm_lang$core$Native_Utils.update(
							_p10,
							{formSteps: _p9._0});
						var newFormState = _user$project$Form_Models$FormLoaded(newForm);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
					...
					var _p11 = A2(
						_elm_lang$core$Debug$log,
						'Error in FormNextButtonClicked',
						_elm_lang$core$Basics$toString(formState));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								form: _user$project$Form_Models$ErrorLoadingForm('Error while loading form step')
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'FormPrevButtonClicked':
				var formState = model.form;
				var _p12 = formState;
				if (_p12.ctor === 'FormLoaded') {
					var _p14 = _p12._0;
					var formStepList = _user$project$Form_Models$previouseFormStep(_p14.formSteps);
					var _p13 = formStepList;
					if (_p13.ctor === 'Err') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									form: _user$project$Form_Models$ErrorLoadingForm(_p13._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
					...
					var _p15 = A2(
						_elm_lang$core$Debug$log,
						'Error in FormPrevButtonClicked',
						_elm_lang$core$Basics$toString(formState));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
	...
	switch (_p0.ctor) {
		case 'EventListRoute':
			return {
				...
				_1: _user$project$Ports$getEvents(
					{ctor: '_Tuple0'})
			};
		case 'FormRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$initialModel(currentRoute),
				_1: _user$project$Ports$getForm(_p0._0)
			};
		default:
			return {
				ctor: '_Tuple2',
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$gotEventList(_user$project$Messages$GotEventsMsg),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$gotForm(
					function (_p1) {
						return _user$project$Messages$GotFormMsg(
							A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Form_FormDecoder$decodeFormList, _p1));
					}),
				_1: {ctor: '[]'}
			}
		});
